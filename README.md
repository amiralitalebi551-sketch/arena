...
## 🌐 زبان و افکت‌های ویژه (نسخه فارسی)

این نسخه کاملاً **فارسی و راست‌به‌چپ (RTL)** است و افکت‌های سطح آژانسی زیر را دارد:

- 🎬 **پری‌لودر سینمایی** — صفحه‌ی ورود با لوگو و نوار پیشرفت (یک‌بار در هر session)
- 🌌 **پس‌زمینه‌ی شیدری زنده (Aurora)** — WebGL با value-noise چندلایه و واکنش به موس
- 🖱️ **دنباله‌ی نورانی موس** + **افکت مگنتیک** روی دکمه‌ها و لینک‌ها
- 🃏 **کارت‌های سه‌بعدی با Tilt** + نور دنبال‌کننده و حاشیه‌ی درخشان
- 🌊 **انتقال نرم بین سکشن‌ها** هنگام اسکرول (opacity + scale + y با easing)
- 🔊 **افکت صوتی ظریف روی hover** (Web Audio API، بدون فایل، پیش‌فرض خاموش با دکمه‌ی کنترل)
- 💎 **هسته‌ی سه‌بعدی iridescent** — fresnel رنگین‌کمانی، inner glow و specular
- 📊 **شمارنده‌ی عددی با ارقام فارسی** و **نوار بی‌نهایت لوگوها (Marquee)**
- 📈 **نوار پیشرفت اسکرول** بالای صفحه

همه‌ی افکت‌ها به `prefers-reduced-motion` احترام می‌گذارند، روی موبایل سبک‌تر
می‌شوند و رندرشان هنگام مخفی‌شدن تب متوقف می‌شود.
