...
export function StaticFallback() {
  return (
    <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
      <div className="absolute left-1/2 top-1/2 h-[60vmin] w-[60vmin] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle_at_35%_30%,#1F9D6B_0%,#178055_35%,#3FCF8E_75%,transparent_100%)] opacity-60 blur-[2px]" />
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_45%,transparent_30%,#0C0D0C_75%)]" />
    </div>
  );
}
